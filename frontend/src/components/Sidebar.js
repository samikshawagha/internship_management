...
const NAV_ITEMS = {
  ...
  company: [
    ...
    { path: '/company-home', icon: '🏠', label: 'Overview' },
    { path: '/internships/create', icon: '➕', label: 'Post Internship' },
    { path: '/internships', icon: '💼', label: 'Internships' },
    { path: '/company-applications', icon: '📋', label: 'Applications' },
    { path: '/company-attendance', icon: '🗓️', label: 'Attendance' },
    { path: '/company-performance', icon: '⭐', label: 'Performance' },
